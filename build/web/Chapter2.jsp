...
session.setAttribute("subject", country);
%>
...
<div>
	<form><div id='contact-form-8'><fieldset>
                    ...
                    <font size="6"><legend>Subject Name : <%= country %></legend></font>
                    <br><br><br>
                   <%
                   ResultSet res=st.executeQuery("Select * from chapter where Subject='"+country+"'");
                   int i=1;
          %>
          <table cellpadding="10" cellspacing="10" width="80%" border="1">
              <tr>
                  <th><label>Chapter  No.</label></th>
                  <th><label>Chapter Name</label></th>
              ...
              <tr>
                  ...
                  <td><center><a href="Chapter3.jsp?flag=<%= res.getString(4)%>" ><%= res.getString(4)%></a></center></td>
                  <td><center><label><%= res.getString(5)%></label></center></td>
