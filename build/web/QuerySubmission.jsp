...
<%
    int a=0 ;
          ...
          session.getAttribute("total_notification");
...
<div>
   ...
   String n2=request.getParameter("n2");
                String n1=request.getParameter("n1");
                   PreparedStatement ps=con.prepareStatement("INSERT into queryhandle VALUES(?,?,?,?)");
...
%>  
  ...
  %>              
                ...
                <font size="5">Answer :</font> &nbsp; &nbsp;
                    <%
                    ResultSet res1=st.executeQuery("Select * from queryhandle where Student_Id='"+Student_Id+"'");
                    while(res1.next())
                    {
                        if(res1.getString(4)=="")
                        {
                    ...
                    <br><br>
                    <center><a href="Home.jsp">Home</a> | <a href="Notification.jsp">Notification</a></center>  
</body>
</html>
