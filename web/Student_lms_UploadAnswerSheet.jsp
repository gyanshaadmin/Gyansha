...
and after uploading file, page is redirected to FileUploaded.jsp
--%>
...
String assignment_id=(String)request.getParameter("f1");
session.setAttribute("assignment_id",assignment_id);
String chapter_id=(String)request.getParameter("f2");
session.setAttribute("chapter_id", chapter_id);
String subject_id=(String)request.getParameter("f3");
...
<p>&nbsp;</p>
<h3>Assignment Id:<%=assignment_id %></h3>
<p>&nbsp;</p>
<h3>Chapter Id:<%=chapter_id %></h3>
<div>

    <form method="post" action="Student_lms_AssignmentUploaded.jsp" name="upform" enctype="multipart/form-data" onsubmit="return check();">
    
                <table width="60%" border="0" cellspacing="1" cellpadding="1" align="center" class="style1">
                    <tr>
                    <td><font color="white">Select a file to upload :</td>
                    </tr>
                    <tr>
