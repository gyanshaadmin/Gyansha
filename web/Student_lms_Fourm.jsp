...
<script>
    function check()
    {
        var selected_index=myform.elements["fourm"].selectedIndex;
        
        if(selected_index >0)
        {
            var selected_option_value=myform.elements["fourm"].options[selected_index].value;
        }
        else
        {
            alert("Please Select Option from drop down list");
        }
    }
</script>
</head>
...
<div>
    <form name="myform"><div id='contact-form-8'><fieldset>
		...
		<legend>Fourm</legend>
              ...
              <br><br>
                <select name="fourm" id="" size="1" onchange="check();">
