...
It is used to login the user by giving Student and password & after submitting redirects to Student_lms_ValidateStudent.jsp ,
...
<script>
    ...
    else if(document.myform.n2.value=="")
    {
...
<p>&nbsp;</p>
<div>
    <form name="myform" action="Student_lms_ValidateStudent.jsp" method="post" onsubmit="return validate();"><div id='contact-form-8'><fieldset>
		...
		<legend>Login Page</legend>
                <table cellpadding="10" cellspacing="10">
                    ...
                    <tr>
                        <th>Password</th>
                        <td><input type="password" name="n2" value=""></td>
